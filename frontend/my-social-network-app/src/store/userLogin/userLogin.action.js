...
export const FETCH_USER_PROTECTED_DATA = createAction("fetch/user/protected/data");
export const FETCH_USER_PROTECTED_DATA_ERROR = createAction("fetch/user/protected/data/error");
